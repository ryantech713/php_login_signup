...
describe(
    ...
    describe(
        ...
        describe(
            'NAME', () => {
            it(
                    'should throw an Error if it is not initialized', () => {
                    expect(
                            () => {
    ...
    describe(
        'Public Methods', () => {
            ...
            'constructor', () => {
                    it(
                    'should accept element, either passed as a CSS selector or DOM element', () => {
                            fixtureEl.innerHTML = [
                            '<div id="foo"></div>',
                            '<div id="bar"></div>'
                            ].join('')
                ...
                it(
                    'should not initialize and add element record to Data (caching), if argument `element` is not an HTML element', () => {
                    fixtureEl.innerHTML = ''
        ...
        describe(
            ...
            it(
                'should de-register element event listeners', () => {
                    createInstance()
        ...
        describe(
            ...
            it(
                'should accept element, either passed as a CSS selector, jQuery element, or DOM element', () => {
                    createInstance()
            ...
            it(
                'should return null when there is no instance', () => {
        ...
        describe(
            ...
            it(
                'should return new instance when there is no alert instance', () => {
                    fixtureEl.innerHTML = '<div id="foo"></div>'
                    element = fixtureEl.querySelector('#foo')
