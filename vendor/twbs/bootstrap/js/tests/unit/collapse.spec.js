...
describe(
    ...
    describe(
        ...
        it(
            'should allow non jquery object in parent config', () => {
                fixtureEl.innerHTML = [
                '<div class="my-collapse">',
                '  <div class="item">',
                '    <a data-bs-toggle="collapse" href="#">Toggle item</a>',
        ...
        it(
            'should allow string selector in parent config', () => {
                fixtureEl.innerHTML = [
                '<div class="my-collapse">',
                '  <div class="item">',
                '    <a data-bs-toggle="collapse" href="#">Toggle item</a>',
    ...
    describe(
        'toggle', () => {
            it(
            'should call show method if show class is not present', () => {
        ...
        it(
            'should call hide method if show class is present', () => {
    ...
    describe(
        'show', () => {
            it(
            'should do nothing if is transitioning', () => {
                    fixtureEl.innerHTML = '<div></div>'
        ...
        it(
            'should do nothing if already shown', () => {
                fixtureEl.innerHTML = '<div class="show"></div>'
        ...
        it(
            'should show a collapsed element on width', () => {
                return new Promise(
                resolve => {
        ...
        it(
            'should be able to handle toggling of other children siblings', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        ...
                        parentCollapseEl.addEventListener(
                            'shown.bs.collapse', () => {
                                expect(parentCollapseEl).toHaveClass('show')
                                childBtn1.click()
                            }
                        )
                    childCollapseEl1.addEventListener(
                        'shown.bs.collapse', () => {
                        expect(childCollapseEl1).toHaveClass('show')
                            childBtn2.click()
                        }
                    )
                    childCollapseEl2.addEventListener(
                        'shown.bs.collapse', () => {
    ...
    describe(
        'data-api', () => {
            it(
            'should prevent url change if click on nested elements', () => {
                    return new Promise(
                    resolve => {
                            fixtureEl.innerHTML = [
        ...
        it(
            'should show multiple collapsed elements', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should hide multiple collapsed elements', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should remove "collapsed" class from target when collapse is shown', () => {
                ...
                resolve => {
                        ...
                        collapseTest1.addEventListener(
                            'shown.bs.collapse', () => {
        ...
        it(
            'should not prevent event for input', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should allow accordion to contain nested elements', () => {
                ...
                resolve => {
                        ...
                        collapseOneEl.addEventListener(
                            'shown.bs.collapse', () => {
                                ...
                                collapseTwoEl.addEventListener(
                                    'shown.bs.collapse', () => {
            ...
            'should allow accordion to target multiple elements', () => {
                ...
                resolve => {
                        ...
                        function secondTest()
                    {
                        ...
                        collapseOneOne.addEventListener(
                            'shown.bs.collapse', () => {
                    ...
                    collapseOneTwo.addEventListener(
                        'shown.bs.collapse', () => {
                        if (collapsedElements.one) {
                            firstTest()
                        } else {
        ...
        it(
            'should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
    ...
    describe(
        ...
        it(
            'should not re create a collapse', () => {
                fixtureEl.innerHTML = '<div></div>'
    ...
    describe(
        'getInstance', () => {
            it(
            'should return collapse instance', () => {
                    fixtureEl.innerHTML = '<div></div>'
        ...
        it(
            'should return null when there is no collapse instance', () => {
                fixtureEl.innerHTML = '<div></div>'
    ...
    describe(
        ...
        it(
            'should return new instance when there is no collapse instance', () => {
                fixtureEl.innerHTML = '<div></div>'
        ...
        it(
            'should return new instance when there is no collapse instance with given configuration', () => {
                fixtureEl.innerHTML = '<div></div>'
        ...
        it(
            ...
            const collapse2 = Collapse.getOrCreateInstance(
                div, {
                    toggle: true
                }
            )
