...
describe(
    ...
    describe(
        'toggle', () => {
        it(
                'should call ScrollBarHelper to handle scrollBar on body', () => {
                return new Promise(
                        resolve => {
                        fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
    ...
    describe(
        ...
        it(
            'should show a modal without backdrop', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should show a modal and append the element', () => {
                return new Promise(
                resolve => {
        ...
        it(
            'should do nothing if a modal is shown', () => {
                fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should do nothing if a modal is transitioning', () => {
                fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should set is transitioning if fade class is present', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = '<div class="modal fade"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should close modal when a click occurred on data-bs-dismiss="modal" inside modal', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should close modal when a click occurred on a data-bs-dismiss="modal" with "bs-target" outside of modal element', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should not trap focus if focus equal to false', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = '<div class="modal fade"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should add listener when escape touch is pressed', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should not close modal when clicking on modal-content', () => {
                return new Promise(
                (resolve, reject) => {
                        fixtureEl.innerHTML = [
                        '<div class="modal">',
        ...
        it(
            'should not close modal when clicking outside of modal-content if backdrop = false', () => {
                return new Promise(
                (resolve, reject) => {
                        fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should not close modal when escape key is pressed with keyboard = false', () => {
                return new Promise(
                (resolve, reject) => {
                        fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
    ...
    describe(
        ...
        it(
            'should not close modal when clicking on an element removed from modal content', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        '<div class="modal">',
        ...
        it(
            'should do nothing is the modal is not shown', () => {
                fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should do nothing is the modal is transitioning', () => {
                fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
        ...
        it(
            'should not hide a modal if hide is prevented', () => {
                return new Promise(
                (resolve, reject) => {
                        fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
    ...
    describe(
        ...
        it(
            'should not recreate a new modal', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        '<button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"></button>',
        ...
        it(
            'should prevent default when the trigger is <a> or <area>', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should focus the trigger on hide', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        '<a data-bs-toggle="modal" href="#" data-bs-target="#exampleModal"></a>',
        ...
        it(
            'should not prevent default when a click occurred on data-bs-dismiss="modal" where tagName is DIFFERENT than <a> or <area>', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        '<div class="modal">',
        ...
        it(
            'should prevent default when a click occurred on data-bs-dismiss="modal" where tagName is <a> or <area>', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        '<div class="modal">',
        ...
        it(
            'should not focus the trigger if the modal is not visible', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
        ...
        it(
            'should not focus the trigger if the modal is not shown', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
                        '<a data-bs-toggle="modal" href="#" data-bs-target="#exampleModal"></a>',
        ...
        it(
            'should call hide first, if another modal is open', () => {
                return new Promise(
                resolve => {
                        fixtureEl.innerHTML = [
    ...
    describe(
        ...
        it(
            'should create a modal with given config', () => {
                fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
    ...
    describe(
        ...
        it(
            'should return null when there is no modal instance', () => {
                fixtureEl.innerHTML = '<div class="modal"><div class="modal-dialog"></div></div>'
    ...
    describe(
        ...
        it(
            'should return new instance when there is no modal instance', () => {
                fixtureEl.innerHTML = '<div></div>'
        ...
        it(
            'should return new instance when there is no modal instance with given configuration', () => {
                fixtureEl.innerHTML = '<div></div>'
        ...
        it(
            ...
            const modal2 = Modal.getOrCreateInstance(
                div, {
                    backdrop: false
                }
            )
