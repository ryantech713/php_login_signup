...
describe(
    ...
    describe(
        'typeCheckConfig', () => {
        it(
                'should check type of the config object', () => {
        ...
        it(
            'should return null stringified when null is passed', () => {
            spyOnProperty(DummyConfigClass, 'DefaultType', 'get').and.returnValue(
                    {
                    toggle: 'boolean',
                    parent: '(null|element)'
        ...
        it(
            'should return undefined stringified when undefined is passed', () => {
            spyOnProperty(DummyConfigClass, 'DefaultType', 'get').and.returnValue(
                    {
                    toggle: 'boolean',
