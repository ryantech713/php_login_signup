...
describe(
    ...
    describe(
        'click callback', () => {
            it(
            'should execute callback on click', () => {
                    return new Promise(
                    resolve => {
        ...
        describe(
            'animation callbacks', () => {
                it(
                'should show and hide backdrop after counting transition duration if it is animated', () => {
                        return new Promise(
                        resolve => {
                                const instance = new Backdrop(
                                {
            ...
            it(
                'should not call delay callbacks if it is not "shown"', () => {
                    return new Promise(
                    resolve => {
                            const instance = new Backdrop(
                            {
        ...
        describe(
            'Config', () => {
                describe(
                'rootElement initialization', () => {
                        it(
                        'should be appended on "document.body" by default', () => {
                                return new Promise(
                                resolve => {
                                        const instance = new Backdrop(
                                        {
                    ...
                    it(
                        'should find the rootElement if passed as a string', () => {
                            return new Promise(
                            resolve => {
                                    const instance = new Backdrop(
                                    {
                    ...
                    it(
                        'should be appended on any element given by the proper config', () => {
                            return new Promise(
                            resolve => {
                                    fixtureEl.innerHTML = '<div id="wrapper"></div>'
            ...
            describe(
                'ClassName', () => {
                    it(
                    'should allow configuring className', () => {
                            return new Promise(
                            resolve => {
                                    const instance = new Backdrop(
                                    {
